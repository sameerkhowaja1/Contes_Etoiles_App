        ...
        children: [
          Align(
              ...
              child: InkWell(
                  ...
                  child: Image.asset(kCancelIcon, width: 28.w, height: 28.h,))),
          ...
          Center(
            child: SizedBox(
                ...
                child: Text(
                  ...
                  style: TextStyle( wordSpacing: 2,fontSize: 18.sp, fontWeight: FontWeight.w400, fontFamily: 'Metropolis', color: kWhiteColor)
                )),
          ),
        ],
      ),
